...
from backend.modules.game_session.events import GameSessionCreatedEvent, GameSessionDeletedEvent, PlayerJoinedEvent, \
    ...
    FinalRoundTimeoutEvent, PlayerInactiveEvent
from backend.modules.game_session.event_handlers import notify_of_game_session_created, \
    notify_of_game_session_deleted, notify_of_player_joined, notify_of_player_left, notify_of_round_started, \
    notify_of_final_round_started, notify_of_current_player_chosen, notify_of_current_question_chosen, \
    notify_of_player_answered, notify_of_answer_timeout, notify_of_final_round_timeout, start_question_timer, \
    stop_question_timer, restart_question_timer, start_final_round_timer, add_creator_to_notifier, \
    add_player_to_notifier, remove_player_from_notifier, remove_group_from_notifier, notify_of_player_inactive
...
EVENT_HANDLERS = {
    ...
    AnswerTimeoutEvent: [notify_of_answer_timeout],
